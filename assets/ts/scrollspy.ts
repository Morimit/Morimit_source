...
function scrollToTocElement(
  tocElement: HTMLElement,
  scrollableNavigation: HTMLElement
) {
...
function buildIdToNavigationElementMap(
  navigation: NodeListOf<Element>
): IdToElementMap {
...
function setupScrollspy() {
  ...
  let scrollableNavigation = document.querySelector(tocQuery) as
    | HTMLElement
    | undefined;
  ...
  let idToNavigationElement: IdToElementMap =
    buildIdToNavigationElementMap(navigation);
